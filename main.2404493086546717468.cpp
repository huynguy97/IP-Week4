...
//                                          
Month calc_month (int year, int day_number)
{
    Month m = January ;
...
int  calc_day (int year, int day_number)
{
    const Month MONTH = calc_month(year, day_number);
...
{
    cout << calc_day (year, day_number);
    cout << ' ' ;
    show_Month (calc_month (year, day_number));
}
