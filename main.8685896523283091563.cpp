   ...
   switch (month)
     {
       ...
       default:           cout << "Unknown month, you need to check information..." ; break ;
     }
}
...
int enter_year ()
{
  ...
  do
     {
       cout << "Enter a year from 1500 to 2100 || 0 to stop: " ;
      cin >> year ;
     }
   ...
   while ( year != 0 )
     {
       ...
       cout << " Carnival is on " ; show_day_number_as_date ( CARNIVAL, year ); cout << ".";
       cout << endl ;
       cout << " Good Friday is on " ; show_day_number_as_date ( GOOD_FRIDAY, year ); cout << "." ;
       cout << endl ;
       cout << " Easter is on " ; show_day_number_as_date ( EASTER, year ); cout << "." ;
       cout << endl ;
       cout << " Ascension is on " ; show_day_number_as_date ( ASCENSION, year ); cout << "." ;
       cout << endl ;
       cout << " Whitsuntide is on " ; show_day_number_as_date ( WHITSUNTIDE, year ); cout << ".";
       cout << endl ;
      year = enter_year () ;
    }
}
