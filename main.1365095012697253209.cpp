...
{
    int year ;
    cout << "What is the year you want to know the holy dates of? \n" ;
    cin >> year;
    return year;
}
...
int carnival_day (int Y)
{
    ...
    //                                                                              
        return number_of_days_in_month(Y, static_cast<Month> (easter_month(Y)-1)) + number_of_days_in_month(Y, static_cast<Month> (easter_month(Y)-2))+ b;
}
...
//                                                                                                   
{
    ...
    if (carnival_day(Y) + 2 <= number_of_days_in_month(Y, static_cast<Month> (carnival_month(Y)))) //                                       
        //                                             
        cout << "End of Carnival " << carnival_month(Y) << "\t" << carnival_day(Y) + 2 << endl;
    else //                                                                                               
    {
        int end_of_carnival_day = carnival_day(Y) + 2 - number_of_days_in_month(Y, static_cast<Month> (carnival_month(Y)));
        cout << "End of Carnival " << carnival_month(Y) + 1 << "\t" << end_of_carnival_day << endl;
    }
