...
void show_Month ( Month month )
{
    ...
    case December :
        ...
        break ;
    default:
        cout << "Unknown month, that is odd..." ;
        break ;
    }
}
...
int enter_year ()
{
    ...
    do
    {
        cout << "Enter a year (1 - 16000) or 0 to stop: " ;
        cin >> year ;
    }
    while ( (year < 1 || year > 16000) && year != 0 );
    return year ;
}
...
void show_holy_days ()
{
    ...
    while ( year != 0 )
    {
        ...
        cout << " Carnival is on " ;
        show_day_number_as_date ( CARNIVAL, year ) ;
        cout << endl ;
        cout << " Good Friday is on " ;
        show_day_number_as_date ( GOOD_FRIDAY, year ) ;
        cout << endl ;
        cout << " Easter is on " ;
        show_day_number_as_date ( EASTER, year ) ;
        cout << endl ;
        cout << " Ascension is on " ;
        show_day_number_as_date ( ASCENSION, year ) ;
        cout << endl ;
        cout << " Whitsuntide is on " ;
        show_day_number_as_date ( WHITSUNTIDE, year ) ;
        cout << endl ;
        year = enter_year () ;
    }
